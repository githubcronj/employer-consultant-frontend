        ...
        {finalData.length === 0 ? (
          <Box
            sx={{
              ...
              px: { xs: "15%", sm: "20%", lg: "25%" },
            }}
          >
            <h1 className="lg:text-2xl font-bold  xl:pl-[17px] lg:pl-[16px] sm:pl-[17px] md:pl-[17px] pl-[5px]  h-[19px] mb-[15px] mt-[15px] text-[#000000] text-left font-sans">
              No Data Available
            </h1>
          </Box>
        ) : (
