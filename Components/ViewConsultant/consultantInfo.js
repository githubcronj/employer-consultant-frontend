    ...
    <>
      <Box sx={{sm:{px:4}}}>
        ...
        <Box sx={{display:'flex',flexDirection:'column',gap:2,justifyContent:'center',alignItems:'center'}}>
          <Button variant="contained" style={{backgroundColor:'#F9342E'}} sx={{borderRadius:'10px',p:{sm:2},width:{sm:'72%',xs:'90%'}}}>Delete Resource Pool</Button>
          <Button variant="contained" style={{backgroundColor:'#F9342E'}} sx={{borderRadius:'10px',p:{sm:2},width:{sm:'72%',xs:'90%'}}}>Edit Resource Pool</Button>
        </Box>
      </Box>
    </>
  );
