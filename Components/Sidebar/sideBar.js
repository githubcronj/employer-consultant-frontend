...
export const SideBar = () => {
  ...
  return (
    <div className="w-auto z-10 h-full">
      ...
      {display && (
        <div
          className={`bg-white w-[245px] h-[100%] fixed ${
        ...
        >
          ...
          >
            <img
              ...
              src={home.src}
            />
            <h5 className="h-[17px] text-left -mt-[9px] text-black pl-[19px] opacity-[1]">
              Home
            </h5>
          </div>
          <div
          ...
          >
            ...
            <h5 className="h-[17px] text-left -mt-[9px] whitespace-nowrap text-black pl-[19px] opacity-[1]">
