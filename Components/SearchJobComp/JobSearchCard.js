...
const JobSearchCard = ({ logo, duration, title, experience, location,flag }) => {
  return (
   ...
   {!flag ? ( <Box
    ...
    >
      <Box>
        <Image src={logo ? logo : companyLogo} alt="logo" width="35" height="35" />
      </Box>
      <Typography
      ...
      <Box>
      <Typography sx={{fontSize:"16px",fontWeight:"bold"}}>{title ? title : "title"}</Typography>
      <Typography sx={{color:"#848484"}}>{experience ? experience : "5"} yr Exp</Typography>
      </Box>
  ...
  >
    ...
    <Typography sx={{fontSize:"16px",fontWeight:"bold"}}>{title ? title : "jobtitle"}</Typography>
    <Typography sx={{color:"#848484"}}>{experience ? experience : "5"} Jobs</Typography>
    </Box>
