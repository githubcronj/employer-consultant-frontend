            ...
            <div className="bg-white sm:w-[370px]">
              ...
              <div className="px-5">
                ...
                `}
                      ...
                      <label
                        for="min"
                        className="absolute my-1 text-gray-500  duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-blue-600 peer-focus: peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4"
                      >
                        Min
                      </label>
                    </div>
                ...
                <div className="my-4">
                  ...
                  <div className="relative flex items-center mt-3">
                    ...
                    <label
                      for="deadline"
                      className="absolute hidden my-1 text-gray-500  duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-blue-600 peer-focus: peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4"
                    >
                      Founded In{" "}
                    </label>
                    <img
