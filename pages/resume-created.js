  ...
  return (
    <div className="bg-[#2B373C1C] py-5 px-2 sm:px-10 mx-auto">
      <div className=" bg-white max-w-[1620px]  mx-2 lg:mx-auto sm:mx-6 lg-mx-8 border rounded-xl grid lg:grid-cols-4">
        ...
        <Image className="mx-auto" src="/Assets/rightClick.png" alt="resume created" width={140} height={140}/>
         <p className="text-[26px] text-[#2B373C] sm:text-2xl font-bold py-8">Your Resume created succesfully</p>
        </div>
