      ...
      >
        <div className='xl:mt-0  flex flex-col items-center justify-center align-middle sm:pl-0  sm:mr-[2px] md:mr-[2px] mb-3 xl:-mb-7 flex-1 '>
          <div
            ...
            className=' xl:w-1/2 xl:ml-[0px] flex flex-col justify-center items-center pt-0  gap-4 '
          >
            <h1
            ...
            <div
              ...
              className='flex  rounded-20 transition-all duration-300 gap-3  border-radius-2 pl-1'
            >
              <button
                style={{
                  borderRadius: '15px',
          ...
          <div
            className='flex items-center mt-3 sm:w-96'
            style={{ width: '405px' }}
          >
