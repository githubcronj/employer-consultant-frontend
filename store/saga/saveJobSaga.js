...
import {  SAVE_FAILURE, SAVE_JOB_SUCCESS, SAVE_SUCCESS, UNSAVE_JOB_FAILURE, UNSAVE_JOB_REQUEST, UNSAVE_JOB_SUCCESS } from "store/type/applyJobType";
...
function* unsaveJobData(action) {
  ...
  try {
    ...
    yield put({ type: UNSAVE_JOB_REQUEST, payload: response.data });
